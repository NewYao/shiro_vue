            ...
            <h2 style="color: white;">
                <div class="login-form">
                    <div class="login-space">
                        <el-form @submit.native.prevent :label-position="labelPosition" label-width="80px" :model="formLabelAlign" :rules="rules" :hide-required-asterisk="true">
...
.bodyArea {
    ...
    background: radial-gradient(200% 100% at bottom center,
            ...
            #75517d,
            #1b2947);
    background: radial-gradient(220% 105% at top center,
            #1b2947 10%,
            #75517d 40%,
            #e96f92 65%,
            #f7f7b6);
