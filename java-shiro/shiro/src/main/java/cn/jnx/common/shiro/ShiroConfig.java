...
import cn.jnx.common.shiro.realms.RealmUsernamePwd;
...
public class ShiroConfig {
     ...
     */
    @Bean
    public RealmUsernamePwd realmUsernamePwd() {
        RealmUsernamePwd myShiroRealm = new RealmUsernamePwd();
        // 设置密码比较器
    ...
    public SecurityManager securityManager() {
        ...
        securityManager.setRealm(realmUsernamePwd());
        securityManager.setRememberMeManager(rememberMeManager());
        securityManager.setCacheManager(myEhCacheManager());// 将缓存管理交给ehCache
        securityManager.setSessionManager(sessionManager());// 使用自定义session管理器
    ...
    public SimpleCookie rememMeCookie() {
        // 初始化设置cookie的名称
        SimpleCookie simpleCookie = new SimpleCookie("shiro-vue-remember");
